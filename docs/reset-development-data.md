...
7. Kiểm tra tài khoản super admin vẫn còn trong **Authentication > Users**. Nếu chưa có, tạo thủ công bằng email và mật khẩu.
8. Mở `superbase/migrations/seed_data.sql`, thay `super_admin@example.com` bằng email tài khoản trên, rồi chạy file.
9. Quay lại **Authentication > Hooks**, bật hook và chọn `public.custom_access_token_hook`.
10. Đăng xuất rồi đăng nhập lại để nhận JWT mới.
